...
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1020, 1014, 1015, N'Браслет с алмазной гранью из серебра', NULL, NULL, NULL, 0, NULL, NULL, 9883633, 5, CAST(800.00 AS Decimal(18, 2)), CAST(1200.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1021, 1013, 1016, N'Серьги детские керамические', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, CAST(700.00 AS Decimal(18, 2)), CAST(900.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1022, 1016, 1015, N'Золотая подвеска с фианитами', N'', N'', NULL, 1, 10, N'', 9883649, 5, CAST(800.00 AS Decimal(18, 2)), CAST(950.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1023, 1012, 1014, N'Золотое кольцо с бриллиантами', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1024, 1012, 1017, N'Платиновое обручальное кольцо', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1025, 1014, 1015, N'Серебряный браслет с керамикой и фианитами', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1026, 1013, 1015, N'Серебряные серьги с изумрудами и топазами', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1027, 1016, 1015, N'Шейное украшение с жемчугом', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
INSERT [dbo].[Product] ([ProductID], [ProductTypeID], [MaterialTypeID], [Name], [Equipment], [Description], [GenderTypeID], [Is_Deleted], [Size], [VendorCode], [VK_ID], [Amounth], [PurchasePrice], [SalePrice]) VALUES (1028, 1016, 1014, N'Золотая подвеска с рубинами и бриллиантами', NULL, NULL, NULL, 1, NULL, NULL, NULL, 4, CAST(500.00 AS Decimal(18, 2)), CAST(650.00 AS Decimal(18, 2)))
GO
